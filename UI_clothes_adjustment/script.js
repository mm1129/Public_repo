...
function paintGarment() { 
  ...
  context.beginPath();
  context.arc(shoulderWidth / 2, 0, 15, 0, 2 * Math.PI, false);
  context.fillStyle = 'blue';
  context.fill();
  context.beginPath();
  context.arc(waistWidth / 2, topLength, 15, 0, 2 * Math.PI, false);
  context.fillStyle = 'blue';
  context.fill();
  ...
  context.beginPath();
  context.arc(sleeveLength, 0, 15, 0, 2 * Math.PI, false);
  context.fillStyle = 'blue';
  context.fill();
...
function handleMouseDown(event) {
  ...
  if (isDragging){
    ...
    document.getElementById('waist').style.backgroundColor = 'red';
    document.getElementById('shoulder').style.backgroundColor = 'green';
    document.getElementById('sleeve').style.backgroundColor = 'blue';
    if(dragType === 'waist'){
